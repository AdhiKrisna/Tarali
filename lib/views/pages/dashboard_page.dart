                                        ...
                                        content: SizedBox(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              authUser != null
                                                  ? Text(
                                                      "Halo, ${authUser.displayName ?? authUser.email}\n${userData?['role'] == 1 ? 'Guru di ${userData?['sekolah'] ?? ' Sekolah ini'}' : 'Murid di ${userData?['sekolah'] ?? ' Sekolah ini'}'}",
                                                      style: PoppinsStyle
                                                          .stylePoppins(
                                                        color: blackText,
                                                        fontWeight:
                                          ...
                                          child: TextField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              suffixIcon: IconButton(
                                                ...
                                                onPressed: () {
                                                  dashboardController.isListening
                                                              .isTrue &&
                                                          dashboardController
                                                              .speechToText
                                                              .isListening
